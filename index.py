...
Original file is located at
    https://colab.research.google.com/github/huggingface/notebooks/blob/main/smolagents_doc/en/tensorflow/index.ipynb
"""
...
login(token="your hugging face token with all inference permissions")
